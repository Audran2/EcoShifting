// noinspection JSUnusedLocalSymbols,CommaExpressionJS,JSStringConcatenationToES6Template,JSUnresolvedVariable,UnnecessaryLocalVariableJS,JSUnresolvedFunction,NpmUsedModulesInstalled,JSValidateTypes,SpellCheckingInspection
...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{
    let g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Parallax = f()}})(function(){
    let define, module, exports;return (function e(t, n, r){function s(o, u){if(!n[o]){if(!t[o]){
        ...
        const n = t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}let i=typeof require=="function"&&require;for(let o=0; o<r.length; o++)s(r[o]);return s})({1:[function(require, module, exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
function shouldUseNative() {
	try {
        ...
        const test1 = String('abc');  // eslint-disable-line no-new-wrappers
		test1[5] = 'de';
...
// didn't break things.  But we need to wrap it in a try catch in case it is
            ...
            const helpers = {
                ...
                transformSupport: function transformSupport(value) {
                    ...
                    let propertySupport = false,
                        ...
                        jsProperty = null;
                    let i = 0;
                    const l = helpers.vendors.length;
                    for (; i < l; i++) {
                ...
                _createClass(Parallax, [{
                    ...
                    value: function updateLayers() {
                        ...
                        for (let index = 0; index < this.layers.length; index++) {
                            ...
                            const depth = helpers.data(layer, 'depth') || 0;
                    ...
                    value: function rotate(beta, gamma) {
                        // Extract Rotation
                        const x = (beta || 0) / MAGIC_NUMBER,
                            //  -90 :: 90
                            y = (gamma || 0) / MAGIC_NUMBER; // -180 :: 180

                        // Detect Orientation Change
                        const portrait = this.windowHeight > this.windowWidth;
